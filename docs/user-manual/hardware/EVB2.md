...
The [EVB-2 PCB assembly design files](https://github.com/inertialsense/IS-hdw/tree/main/Products/EVB-2) are available as open source hardware on GitHub.

In particular, full schematics for the board can be found [here](https://github.com/inertialsense/IS-hdw/blob/main/Products/EVB-2/EVB-2-1/Schematic/EVB-2-1-2_Schematic%20Prints.PDF).
