# Hardware Integration: RUG-4 (Rugged-4)
...
- Dual onboard all-band (L1/L2/L5/L6) GNSS receivers
...
The following table shows the Rugged-4 pinout.  Note that pin function can change based on changing  `DID_FLASH_CONFIG.platformConfig` (see [I/O Configuration](#io-configuration) below).
