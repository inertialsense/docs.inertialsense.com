...
The following examples NMEA messages enable IMX data streaming output.  The data period is 1, full [data source rates](isb.md#data-source-update-rates), for those that do not specify the output rate.
