...
* `INS_STATUS_GNSS_AIDING_HEADING` - either dual or single GPS. 
...
| INS_STATUS_GNSS_AIDING_HEADING | INS heading is being corrected by GPS.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| INS_STATUS_GNSS_AIDING_POS | INS position and velocity are being corrected by GPS. |
| INS_STATUS_GNSS_UPDATE_IN_SOLUTION | GPS update event occurred in INS, potentially causing discontinuity in position path.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
