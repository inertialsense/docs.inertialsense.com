...
(() => {
  const contentQuestions = [
    ...
    { question: "What hardware kit is highlighted in the README?", correct: "EVB-2 with IMX-G2, dual GNSS, RTK, logging, radios, and SAME70 bridge", distractors: ["EVB-1 only", "No evaluation hardware", "BLE tag only"], source: "user-manual/SDK/README.md" },
