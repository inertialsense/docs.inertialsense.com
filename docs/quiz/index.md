...
(() => {
  const contentQuestions = [
    ...
    { question: "Where do you set the GNSS antenna lever arm offsets?", correct: "DID_FLASH_CONFIG.gnss1AntOffset / gpsAnt2Offset", distractors: ["insRotation", "platformConfig", "sensorConfig"], source: "user-manual/application-config/imu_ins_gnss_configuration.md" },
    ...
    { question: "Which value sets EKF output/update periods at startup?", correct: "DID_FLASH_CONFIG.startupNavDtMs (sets navOutputDtMs/navUpdateDtMs)", distractors: ["startupImuDtMs only", "gnss1AntOffset", "dynamicModel"], source: "user-manual/application-config/imu_ins_gnss_configuration.md" },
    ...
    { question: "Under what license is the SDK released?", correct: "MIT License (2014-2025 Inertial Sense)", distractors: ["GPLv3", "Proprietary only", "Apache 1.0"], source: "user-manual/SDK/README.md" },
