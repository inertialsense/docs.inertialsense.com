...
(() => {
  const contentQuestions = [
    ...
    { question: "Which field holds GPX hardware flags?", correct: "gpx_status_t.hdwStatus per eGPXHdwStatusFlags", distractors: ["DID_SYS_SENSORS.temp", "INS_STATUS_SOLUTION_MASK", "gps1AntOffset"], source: "user-manual/reference/GPX_system_status.md" },
    ...
    { question: "What flag warns the RTK compassing baseline is unset?", correct: "INS_STATUS_RTK_COMPASSING_BASELINE_UNSET", distractors: ["HDW_STATUS_ERR_TEMPERATURE", "SYS_CFG_BITS_DISABLE_MAGNETOMETER_FUSION", "GPS_STATUS_BAD_FIX"], source: "user-manual/reference/IMX_system_status.md" },
