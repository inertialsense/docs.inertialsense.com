...
(() => {
  const contentQuestions = [
    ...
    { question: "How is SPI enabled on the IMX module?", correct: "Hold pin 10 (G9/nSPI_EN) low during boot", distractors: ["Pull pin 3 high", "Send an SPI unlock command", "Short pins 6 and 7"], source: "user-manual/hardware/module_uins3.md" },
    { question: "Where should the 100nF decoupling capacitor be placed for IMX?", correct: "Between VCC and GND close to the module on the same PCB side", distractors: ["Across USB lines", "Across PPS and ground", "Between VBAT and ground with vias"], source: "user-manual/hardware/module_imx5.md" },
    ...
    { question: "Which status flags indicate RTK fix in code?", correct: "INS_STATUS_NAV_FIX_STATUS == GNSS_NAV_FIX_POSITIONING_RTK_FIX or GNSS_STATUS_FLAGS_GNSS1_RTK_POSITION_VALID", distractors: ["Check CAN errors", "Look for NMEA checksum", "Ping the device"], source: "user-manual/gnss/rtk_positioning_overview.md" },
    ...
    { question: "Where do you set GPS antenna offsets for dead reckoning?", correct: "EvalTool > Data Sets > DID_FLASH_CONFIG > gnss1AntOffsetX/Y/Z", distractors: ["In CAN config", "In SPI mode", "Via PPS line"], source: "user-manual/dead-reckoning/dead_reckoning.md" },
    ...
    { question: "What is Sensor Rotation used for?", correct: "Rotate IMU/magnetometer output by 90° multiples via sensorConfig to match sensor frame", distractors: ["Small angle trim", "Changing GPS type", "Resetting INS"], source: "user-manual/application-config/imu_ins_configuration.md" },
    { question: "What is INS Rotation used for?", correct: "Small angle alignment from sensor frame to vehicle frame via insRotation (Z,Y,X order)", distractors: ["90° gross rotation", "Moving GPS antenna", "Setting baud"], source: "user-manual/application-config/imu_ins_configuration.md" },
    { question: "What does INS Offset do?", correct: "Shifts INS output location to a desired point on the vehicle", distractors: ["Sets IMU scale", "Resets biases", "Changes GNSS type"], source: "user-manual/application-config/imu_ins_configuration.md" },
    { question: "Where do you set the GNSS antenna lever arm offsets?", correct: "DID_FLASH_CONFIG.gnss1AntOffset / gnss2AntOffset", distractors: ["insRotation", "platformConfig", "sensorConfig"], source: "user-manual/application-config/imu_ins_configuration.md" },
    { question: "How do you disable magnetometer or barometer fusion?", correct: "Set SYS_CFG_BITS_DISABLE_MAGNETOMETER_FUSION or _DISABLE_BAROMETER_FUSION in sysCfgBits", distractors: ["Unplug sensors", "Change baud rate", "Set dynamicModel"], source: "user-manual/application-config/imu_ins_configuration.md" },
    { question: "What parameter sets IMU sample period?", correct: "DID_FLASH_CONFIG.startupImuDtMs (ms)", distractors: ["startupNavDtMs", "sensorConfig", "platformConfig"], source: "user-manual/application-config/imu_ins_configuration.md" },
    { question: "Which value sets EKF output/update periods at startup?", correct: "DID_FLASH_CONFIG.startupNavDtMs (sets navOutputDtMs/navUpdateDtMs)", distractors: ["startupImuDtMs only", "gnss1AntOffset", "dynamicModel"], source: "user-manual/application-config/imu_ins_configuration.md" },
    { question: "Which GNSS signals does ZED-F9P support for rover positioning per the guide?", correct: "L1/L2 GPS, L1/L2 GLONASS, E1/E5 Galileo, B1/B2 BeiDou", distractors: ["L1 only", "GLONASS only", "SBAS only"], source: "user-manual/imx/gnss-aiding/imx_gnss_ublox.md" },
    { question: "How do you enable RTCM input on ZED-F9P in this setup?", correct: "Configure UBX-CFG-MSG to enable RTCM3 inputs on the chosen port", distractors: ["Send NMEA only", "Enable CAN frames", "Use SBAS messages"], source: "user-manual/imx/gnss-aiding/imx_gnss_ublox.md" },
    { question: "What EvalTool tab helps set GPS type and RTK mode for F9P rover?", correct: "Settings > GPS", distractors: ["INS tab", "About tab", "Data Logs tab"], source: "user-manual/imx/gnss-aiding/imx_gnss_ublox.md" },
    { question: "What does the GPX-1 provide when paired with IMX-5?", correct: "Multi-frequency GNSS with dual antenna support for RTK positioning and compassing", distractors: ["Only Wi-Fi connectivity", "Bluetooth only", "Ethernet"], source: "user-manual/imx/gnss-aiding/imx_gnss_gpx.md" },
    { question: "How is active antenna power delivered on GPX-1?", correct: "Via VCC_RF through an inductor to GNSS1_RF/GNSS2_RF (3.3V)", distractors: ["Direct 5V", "Via USB", "No antenna power"], source: "user-manual/imx/gnss-aiding/imx_gnss_gpx.md" },
    { question: "Which message format is recommended between IMX and GPX-1 for RTK?", correct: "RTCM3 forwarded to GPX-1", distractors: ["Only NMEA", "CAN frames", "HTTP"], source: "user-manual/imx/gnss-aiding/imx_gnss_gpx.md" },
    { question: "What type of antenna is required for GPX-1?", correct: "Active L1/L5 GNSS antenna", distractors: ["Passive only", "Loop antenna", "No antenna needed"], source: "user-manual/imx/gnss-aiding/imx_gnss_gpx.md" },
    { question: "Which EvalTool setting selects GPX RTK mode?", correct: "GPS RTK set to Position or Compass for GPX-1", distractors: ["Set to SBAS only", "Disable RTK", "Use F9 Compass"], source: "user-manual/imx/gnss-aiding/imx_gnss_gpx.md" },
    ...
    { question: "How does the system represent GPS time internally?", correct: "Week number plus GPS time-of-week in seconds", distractors: ["Unix epoch only", "UTC ISO string", "Local PC clock"], source: "user-manual/general-configuration/time_sync.md" },
    { question: "How is UTC derived from GPS time per the time sync guide?", correct: "UTC = GPS time minus leap seconds", distractors: ["UTC always equals GPS time", "UTC adds leap seconds to GPS", "UTC uses local daylight offsets"], source: "user-manual/general-configuration/time_sync.md" },
    { question: "How is PPS alignment recommended in the time sync guide?", correct: "Sample the PPS edge and pair it with the local time to align clocks", distractors: ["Ignore PPS", "Average multiple PPS edges", "Use CAN time messages only"], source: "user-manual/general-configuration/time_sync.md" },
    { question: "Which STROBE inputs can capture timestamps for IMX?", correct: "Pins G2, G5, G8, or G9 configured as timestamp inputs", distractors: ["USB D+/D-", "Only CANL/H", "Only SPI MISO"], source: "user-manual/general-configuration/time_sync.md" },
    { question: "How do you enable STROBE output on G9 for timing?", correct: "Set IO_CONFIG_G9_STROBE_OUTPUT_NAV in DID_FLASH_CONFIG.ioConfig", distractors: ["Send $STPB", "Enable CAN", "Pull G9 low at boot"], source: "user-manual/general-configuration/time_sync.md" },
    { question: "What does the zero motion command tell the EKF?", correct: "Device is stationary for ~2 seconds to aid bias estimation", distractors: ["Device is accelerating", "GPS is disabled", "IMU is rebooting"], source: "user-manual/general-configuration/zero_motion_command.md" },
    { question: "How can you invoke zero motion from the GUI?", correct: "Press the Zero Motion button to send the command", distractors: ["Power cycle the unit", "Change baud rate", "Toggle PPS polarity"], source: "user-manual/general-configuration/zero_motion_command.md" },
    { question: "When should you end zero motion mode?", correct: "When INS_STATUS_STATIONARY_MODE clears or just before vehicle moves", distractors: ["After reboot only", "After GPS fix", "Never"], source: "user-manual/general-configuration/zero_motion_command.md" },
    { question: "Why is zero motion risky if the platform is moving?", correct: "Forcing stationary assumptions can corrupt the filter while in motion", distractors: ["It resets baud rate", "It wipes flash", "It erases GPS ephemeris"], source: "user-manual/general-configuration/zero_motion_command.md" },
    { question: "How can you improve the effect of zero motion aiding?", correct: "Send the command multiple times to reinforce stationary detection", distractors: ["Disable IMU", "Lower PPS rate", "Change antenna offset"], source: "user-manual/general-configuration/zero_motion_command.md" },
    { question: "What does the UART baud rate table highlight about high speeds?", correct: "Actual baud may differ from target, especially above 460800 bps", distractors: ["Baud is always exact", "Only low speeds vary", "CAN controls baud"], source: "user-manual/general-configuration/UART.md" },
    { question: "What is the actual baud near 921600 on IMX-5 per the table?", correct: "About 919,540 bps", distractors: ["Exactly 921,600", "500,000", "1,000,000"], source: "user-manual/general-configuration/UART.md" },
    { question: "What is the actual baud near 921600 on uINS-3 per the guide?", correct: "About 937,500 bps", distractors: ["Exactly 921,600", "460,800", "2,000,000"], source: "user-manual/general-configuration/UART.md" },
    { question: "What clock does IMX-5 use for baud generation?", correct: "80 MHz base clock supporting up to ~5 Mbps", distractors: ["16 MHz always", "GPS PPS only", "External crystal only"], source: "user-manual/general-configuration/UART.md" },
    { question: "What general guidance is given for rounded high-speed UART rates?", correct: "Expect small deviations and match host baud tolerance at high speeds", distractors: ["Use only default baud", "Only SPI works fast", "Disable flow control"], source: "user-manual/general-configuration/UART.md" },
    { question: "What standard baud rates are listed in system configuration?", correct: "19200, 38400, 57600, 115200, 230400, 460800, 921600", distractors: ["Only 9600", "Only 10 Mbps", "CAN-only speeds"], source: "user-manual/general-configuration/system_configuration.md" },
    { question: "How are high-speed baud rates above 921600 handled?", correct: "They are rounded to the nearest supported rate", distractors: ["Rejected outright", "Forced to 115200", "Always exact"], source: "user-manual/general-configuration/system_configuration.md" },
    { question: "Where can you set serial baud rates persistently?", correct: "In DID_FLASH_CONFIG ser0/ser1/ser2 baud fields", distractors: ["INS status", "CAN config", "EvalTool About tab"], source: "user-manual/general-configuration/system_configuration.md" },
    { question: "How can you set baud from the command line tool?", correct: "Use CLTool with -flashConfig=serXBaudRate=<value>", distractors: ["Send $STPB", "Use only EvalTool", "Edit firmware source"], source: "user-manual/general-configuration/system_configuration.md" },
    { question: "What note is given about serial baud for non-standard values?", correct: "Values above 921600 will be rounded to the closest achievable rate", distractors: ["They brick the device", "They disable GPS", "They force CAN mode"], source: "user-manual/general-configuration/system_configuration.md" },
    { question: "How do you enable WMM magnetic declination usage?", correct: "Set SYS_CFG_BITS_MAG_ENABLE_WMM_DECLINATION in sysCfgBits", distractors: ["Change baud", "Disable magnetometer fusion", "Press Zero Motion"], source: "user-manual/general-configuration/world_magnetic_model.md" },
    { question: "Where can you view the computed magnetic declination?", correct: "In DID_INL2_STATES.magDec", distractors: ["In PPS timing", "In CAN config", "In INS rotation only"], source: "user-manual/general-configuration/world_magnetic_model.md" },
    { question: "How does AHRS mode pick the reference location for WMM?", correct: "Uses refLla (flash_config) when GNSS is not available", distractors: ["Always zero", "Random location", "USB location"], source: "user-manual/general-configuration/world_magnetic_model.md" },
    { question: "How often is the World Magnetic Model updated per the doc?", correct: "Every five years", distractors: ["Daily", "Never", "Only with firmware updates"], source: "user-manual/general-configuration/world_magnetic_model.md" },
    { question: "What does WMM provide for the system?", correct: "Magnetic declination to align magnetometer measurements to true north", distractors: ["GPS ephemeris", "CAN timing", "UART framing"], source: "user-manual/general-configuration/world_magnetic_model.md" },
    { question: "What does the GPX VCC_RF pin supply?", correct: "Power for active GNSS antennas on pin 16", distractors: ["Only GPIO power", "CAN bus power", "No power output"], source: "user-manual/gpx/configuration.md" },
    { question: "How do you disable the GPX active antenna power output?", correct: "Set GPX_SYS_CFG_BITS_DISABLE_VCC_RF in DID_GPX_FLASH_CFG.sysCfgBits", distractors: ["Pull pin 16 low", "Send $STPB", "Disable PPS"], source: "user-manual/gpx/configuration.md" },
    { question: "Which bitfield controls VCC_RF enable on GPX modules?", correct: "DID_GPX_FLASH_CFG.sysCfgBits", distractors: ["DID_FLASH_CONFIG.sysCfgBits", "DID_CAN_CONFIG", "DID_SYS_PARAMS"], source: "user-manual/gpx/configuration.md" },
    { question: "Why might you disable VCC_RF on GPX?", correct: "To avoid powering an external active antenna or use external bias-tee power", distractors: ["To enable UART", "To clear calibration", "To switch to CAN"], source: "user-manual/gpx/configuration.md" },
    { question: "Which pin carries the GPX antenna power output by default?", correct: "Pin 16 (VCC_RF)", distractors: ["Pin 1", "Pin 5", "Pin 25"], source: "user-manual/gpx/configuration.md" },
    { question: "Which tools support IS data logging per the overview?", correct: "EvalTool, CLTool, and the C++ SDK", distractors: ["Only EvalTool", "Only mobile app", "Only CAN utility"], source: "user-manual/logging-plotting/overview.md" },
    { question: "What file formats are supported for logging in the overview?", correct: "Binary (.raw/.dat), CSV, and KML", distractors: ["PCAP only", "JSON only", "BINX only"], source: "user-manual/logging-plotting/overview.md" },
    { question: "What is the difference between raw and serial data logs?", correct: "Raw logs bytes exactly as on the wire; serial logs are optimized for real-time streaming", distractors: ["Raw is parsed JSON", "Serial removes headers", "They are identical"], source: "user-manual/logging-plotting/overview.md" },
    { question: "How are .dat log files named per the overview?", correct: "LOG_SNXXXXX_YYYYMMDD_HHMMSS_CNT.dat", distractors: ["device.log", "data_<epoch>.bin", "session.txt"], source: "user-manual/logging-plotting/overview.md" },
    { question: "What is the chunk header marker value in .dat logs?", correct: "0xFC05EA32", distractors: ["0xAA55AA55", "0xFFFFFFFF", "0x12345678"], source: "user-manual/logging-plotting/overview.md" },
    { question: "Where is the SDK logging interface defined?", correct: "SDK/src/ISLogger.h", distractors: ["EvalTool.exe", "DID_FLASH_CONFIG", "GNSS firmware"], source: "user-manual/logging-plotting/data_logging.md" },
    { question: "How do you change the EvalTool log folder?", correct: "Edit Documents/Inertial Sense/settings.json and set logger \"Directory\"", distractors: ["Use $STPB", "Change baud rate", "Reinstall EvalTool"], source: "user-manual/logging-plotting/data_logging.md" },
    { question: "Which RMC preset enables post-process data logs?", correct: "RMC_PRESET_IMX_PPD", distractors: ["RMC_PRESET_INS", "RMC_PRESET_CAN", "RMC_PRESET_NMEA"], source: "user-manual/logging-plotting/data_logging.md" },
    { question: "How do you start a PPD log in EvalTool?", correct: "Press the \"Data Log: PPD Log\" button in the Data Logs tab", distractors: ["Use the About tab", "Send $PERS", "Change to GPS tab"], source: "user-manual/logging-plotting/data_logging.md" },
    { question: "What CLTool command logs PPD data from the doc?", correct: "cltool -c <port> -presetPPD -lon", distractors: ["cltool -gpsOnly", "cltool -baud=115200", "cltool -nmea"], source: "user-manual/logging-plotting/data_logging.md" },
    { question: "What does Log Inspector plot according to the plotting guide?", correct: "Inertial Sense .dat PPD logs", distractors: ["Only CSV files", "Only KML maps", "Firmware images"], source: "user-manual/logging-plotting/data_plotting.md" },
    { question: "Which CLTool option replays a log file?", correct: "-rp <path>", distractors: ["-logstart", "-flashConfig", "-ppdOnly"], source: "user-manual/logging-plotting/data_plotting.md" },
    { question: "How do you replay a log as fast as possible quietly?", correct: "cltool -rp <path> -rs=0 -q", distractors: ["cltool -nmea", "cltool -baud=0", "cltool -silent"], source: "user-manual/logging-plotting/data_plotting.md" },
    { question: "Which command replays a log at 1x speed per the example?", correct: "cltool -rp IS_logs/20180801_222310", distractors: ["cltool -replay1x", "cltool -gpsonly", "cltool -imu"], source: "user-manual/logging-plotting/data_plotting.md" },
    { question: "Name one third-party tool suggested for log analysis.", correct: "Matlab, Python, or Excel", distractors: ["Photoshop", "Illustrator", "GarageBand"], source: "user-manual/logging-plotting/data_plotting.md" },
    { question: "How long was the simulated outage in the parking lot example?", correct: "30 seconds over 605 meters with ~2.5 m error", distractors: ["5 seconds", "10 minutes", "No outage was simulated"], source: "user-manual/dead-reckoning/dead_reckoning_examples.md" },
    { question: "How was GNSS outage simulated in the parking lot example?", correct: "Disabled GPS fusion in EvalTool during the drive", distractors: ["Unplugged IMU", "Cut power to antennas", "Switched to CAN"], source: "user-manual/dead-reckoning/dead_reckoning_examples.md" },
    { question: "What was the drift after the parking garage example?", correct: "About 2 meters after 105 seconds and 349 meters", distractors: ["20 meters", "No drift", "10 centimeters"], source: "user-manual/dead-reckoning/dead_reckoning_examples.md" },
    { question: "Did the dead reckoning examples use wheel sensors?", correct: "No, they ran without wheel sensors", distractors: ["Yes, dual wheel encoders", "Optical odometry", "Radar odometry"], source: "user-manual/dead-reckoning/dead_reckoning_examples.md" },
    { question: "What happens when GPS fusion is re-enabled after outage?", correct: "INS solution snaps back to GPS, removing accumulated error", distractors: ["Device reboots", "EKF stops", "Nothing changes"], source: "user-manual/dead-reckoning/dead_reckoning_examples.md" },
    { question: "Where are data set definitions maintained per the doc?", correct: "In SDK/src/data_sets.h", distractors: ["Only in EvalTool", "Only in firmware hex", "In CSV templates"], source: "user-manual/com-protocol/DID-descriptions.md" },
    { question: "What does DID_INS_1 output include?", correct: "Euler roll/pitch/yaw with NED position relative to ref LLA", distractors: ["Only ECEF pose", "Only accelerometer data", "Only magnetometer"], source: "user-manual/com-protocol/DID-descriptions.md" },
    { question: "What distinguishing data does DID_INS_3 provide?", correct: "Quaternion to body plus ECEF position", distractors: ["Barometer only", "Only CSV logs", "Camera images"], source: "user-manual/com-protocol/DID-descriptions.md" },
    { question: "What is the max update guidance for DID_PIMU?", correct: "Minimum period is startupImuDtMs or 4 ms, about 250 Hz max", distractors: ["1 Hz only", "10 kHz guaranteed", "Fixed 100 ms"], source: "user-manual/com-protocol/DID-descriptions.md" },
    { question: "Which sensor fields are included in DID_BAROMETER?", correct: "Pressure, MSL altitude, temperature, and humidity", distractors: ["Only voltage", "Only gyro bias", "Only PPS timing"], source: "user-manual/com-protocol/DID-descriptions.md" },
    { question: "When are the hardware and sensor frames equivalent?", correct: "When DID_FLASH_CONFIG.sensorConfig rotation is zero", distractors: ["Only in AHRS mode", "Only with GPS fix", "Never"], source: "user-manual/reference/coordinate_frames.md" },
    { question: "When do sensor and INS output frames align?", correct: "When insRotation and insOffset are zero", distractors: ["Only after calibration", "Only in NAV mode", "With PPS locked"], source: "user-manual/reference/coordinate_frames.md" },
    { question: "How is INS output frame derived from sensor frame?", correct: "Rotate by insRotation (heading, pitch, roll) then translate by insOffset", distractors: ["Only translates", "Only scales axes", "Uses magnetometer only"], source: "user-manual/reference/coordinate_frames.md" },
    { question: "What are the NED axis directions?", correct: "X north, Y east, Z down", distractors: ["X east, Y north, Z up", "X up, Y north, Z east", "All axes arbitrary"], source: "user-manual/reference/coordinate_frames.md" },
    { question: "Where is the origin of the ECEF frame?", correct: "Center of the Earth, rotating with Earth", distractors: ["At the IMX", "At the local base station", "At Greenwich only"], source: "user-manual/reference/coordinate_frames.md" },
    { question: "What distinguishes cold, warm, and hot GPS starts?", correct: "Cold lacks prior data, warm has almanac, hot keeps valid ephemeris", distractors: ["They refer to temperature", "Only antenna changes", "Only baud rate changes"], source: "user-manual/reference/definitions.md" },
    { question: "What does battery backup preserve for faster GPS starts?", correct: "GPS time, position, and almanac when powered off", distractors: ["IMU biases only", "Firmware settings only", "Magnetometer calibration only"], source: "user-manual/reference/definitions.md" },
    { question: "What is another name for Preintegrated IMU in the doc?", correct: "Delta theta/delta velocity (coning and sculling integrals)", distractors: ["GNSS almanac", "RTK baseline", "CAN frame"], source: "user-manual/reference/definitions.md" },
    { question: "What does IMU bias repeatability describe?", correct: "Turn-on bias variation between power cycles", distractors: ["Long-term drift only", "Temperature rise", "PPS jitter"], source: "user-manual/reference/definitions.md" },
    { question: "Why is random walk important for INS accuracy?", correct: "Sensor noise accumulates during integration, causing drift", distractors: ["It lowers baud rate", "It improves C/N0", "It cools the unit"], source: "user-manual/reference/definitions.md" },
    { question: "When does the system rely on the magnetometer for heading?", correct: "In AHRS mode, with no GPS fix, or during constant-velocity GPS motion", distractors: ["Only during RTK fix", "Never uses magnetometer", "Only underwater"], source: "user-manual/reference/magnetometer.md" },
    { question: "How do you disable magnetometer fusion into the INS?", correct: "Set SYS_CFG_BITS_DISABLE_MAGNETOMETER_FUSION in sysCfgBits", distractors: ["Unplug the antenna", "Set dynamicModel to 0", "Disable PPS"], source: "user-manual/reference/magnetometer.md" },
    { question: "How do you force an external magnetometer recalibration?", correct: "Set DID_MAG_CAL.recalCmd to multi-axis or single-axis and rotate the system", distractors: ["Power cycle twice", "Send $STPB", "Change baud rate"], source: "user-manual/reference/magnetometer.md" },
    { question: "How is recalibration completion indicated?", correct: "INS_STATUS_MAG_RECALIBRATING clears or DID_MAG_CAL.progress reaches 100%", distractors: ["LED turns blue", "Baud doubles", "EvalTool closes"], source: "user-manual/reference/magnetometer.md" },
    { question: "How do you enable automatic magnetometer recalibration?", correct: "Set SYS_CFG_BITS_AUTO_MAG_RECAL in flash sysCfgBits", distractors: ["Press Zero Motion", "Enable CAN", "Send $PERS"], source: "user-manual/reference/magnetometer.md" },
    { question: "What common sources of interference are called out?", correct: "Digital lines/USB 3.x noise, power supply noise, EMI near GPS antenna/module", distractors: ["Only sunlight", "Only Bluetooth", "Only humidity"], source: "user-manual/reference/interference.md" },
    { question: "How do you check for IMU noise from interference in EvalTool?", correct: "Watch 5-second σ columns in Sensors tab while the unit is stationary", distractors: ["Use CAN monitor", "Check LED color only", "Read PPS pulse width"], source: "user-manual/reference/interference.md" },
    { question: "What GPS metric helps spot interference per the guide?", correct: "CNO mean/maximum in DID_GPS_NAV or GPS tab", distractors: ["CPU temperature", "UART baud rate", "LED brightness"], source: "user-manual/reference/interference.md" },
    { question: "What antenna placement is recommended to mitigate EMI?", correct: "Mount on top of the vehicle, clear of obstructions and noisy electronics", distractors: ["Place under the IMX", "Wrap in foil indoors", "Put next to USB3 hub"], source: "user-manual/reference/interference.md" },
    { question: "What vibration level can degrade accuracy?", correct: "Mechanical vibrations exceeding about 3 g, especially 100–150 Hz", distractors: ["Any vibration", "Only DC offsets", "No impact from vibration"], source: "user-manual/reference/interference.md" },
    { question: "What is the ARW conversion for the IMX-5 gyro?", correct: "0.16°/√hr ≈ 0.00267°/√s", distractors: ["0.16°/√hr ≈ 0.16°/√s", "0.016°/√s", "1.6°/√s"], source: "user-manual/reference/imu_specifications.md" },
    { question: "What is the gyro angle drift standard deviation at 100 Hz?", correct: "About 0.000267° per sample", distractors: ["0.0267°", "0.1°", "1°"], source: "user-manual/reference/imu_specifications.md" },
    { question: "What is the VRW converted to per √s?", correct: "0.02 m/s/√hr ≈ 0.000333 m/s/√s", distractors: ["0.02 m/s/√s", "0.00333 m/s/√s", "0.0333 m/s/√s"], source: "user-manual/reference/imu_specifications.md" },
    { question: "What is the accelerometer noise σ at 100 Hz per the example?", correct: "≈0.00333 m/s²", distractors: ["0.0333 m/s²", "0.000333 m/s²", "0.3 m/s²"], source: "user-manual/reference/imu_specifications.md" },
    { question: "What gyro rate noise σ at 100 Hz does the doc derive?", correct: "≈0.0267°/s", distractors: ["0.00267°/s", "0.267°/s", "2.67°/s"], source: "user-manual/reference/imu_specifications.md" },
    { question: "Where do you find GPX status definitions?", correct: "In data_sets.h under eGpxStatus and eGPXHdwStatusFlags", distractors: ["EvalTool About tab", "Only in firmware release notes", "Not documented"], source: "user-manual/reference/GPX_system_status.md" },
    { question: "Which data set outputs GPX system status?", correct: "DID_GPX_STATUS carrying gpx_status_t", distractors: ["DID_SYS_PARAMS only", "DID_INS_1", "DID_MAG_CAL"], source: "user-manual/reference/GPX_system_status.md" },
    { question: "Which field holds GPX status bits?", correct: "gpx_status_t.status", distractors: ["flashCfg.sysCfgBits", "gpsNav.fixType", "insStatus"], source: "user-manual/reference/GPX_system_status.md" },
    { question: "Which field holds GPX hardware flags?", correct: "gpx_status_t.hdwStatus per eGPXHdwStatusFlags", distractors: ["DID_SYS_SENSORS.temp", "INS_STATUS_SOLUTION_MASK", "gnss1AntOffset"], source: "user-manual/reference/GPX_system_status.md" },
    { question: "Where is the most current GPX status info maintained?", correct: "In the SDK data_sets.h file", distractors: ["Only printed labels", "EvalTool splash screen", "Old PDF only"], source: "user-manual/reference/GPX_system_status.md" },
    { question: "What do INS_STATUS_HDG_ALIGN_COARSE/FINE indicate?", correct: "Whether heading aiding is coarse or within spec", distractors: ["GPS fix type", "Temperature alarms", "CAN errors"], source: "user-manual/reference/IMX_system_status.md" },
    { question: "What does INS_STATUS_SOLUTION_MASK report?", correct: "Whether the solution is off, aligning, NAV, NAV high variance, AHRS, or VRS", distractors: ["UART speed", "RTK base mode", "Mag calibration mode"], source: "user-manual/reference/IMX_system_status.md" },
    { question: "What flag warns the RTK compassing baseline is unset?", correct: "INS_STATUS_RTK_COMPASSING_BASELINE_UNSET", distractors: ["HDW_STATUS_ERR_TEMPERATURE", "SYS_CFG_BITS_DISABLE_MAGNETOMETER_FUSION", "GNSS_STATUS_BAD_FIX"], source: "user-manual/reference/IMX_system_status.md" },
    { question: "Where are common INS status flags defined?", correct: "eInsStatusFlags in data_sets.h (used in insStatus fields)", distractors: ["EvalTool About tab", "Only in GNSS manual", "Not defined"], source: "user-manual/reference/IMX_system_status.md" },
    { question: "How do you run a full stationary BIT?", correct: "Set DID_BIT.command to BIT_CMD_FULL_STATIONARY (2)", distractors: ["Send $STPB", "Pull PPS high", "Change baud"], source: "user-manual/reference/IMX_system_status.md" },
    { question: "How is the bootloader triggered for firmware update?", correct: "Send a bootloader enable command to reboot into bootloader mode", distractors: ["Hold reset for 10s", "Toggle PPS polarity", "Change baud to 9600"], source: "user-manual/reference/bootloader.md" },
    { question: "What handshake sequence starts bootloader comms?", correct: "Five consecutive 'U' characters spaced ~10 ms", distractors: ["$BOOT command", "CAN frame 0x100", "SPI CS toggle"], source: "user-manual/reference/bootloader.md" },
    { question: "When does the IMX return to application mode?", correct: "Only after a valid firmware upload completes", distractors: ["After 5 minutes", "After power cycle regardless", "After GPS fix"], source: "user-manual/reference/bootloader.md" },
    { question: "Which ports can update the bootloader per the guide?", correct: "Serial0 or native USB only", distractors: ["CAN bus", "SPI", "Any UART"], source: "user-manual/reference/bootloader.md" },
    { question: "What known bootloader issue is noted for old versions?", correct: "UARTs disable after ~50s without handshake (v5g and prior)", distractors: ["GPS lock fails", "CAN stuck dominant", "USB overheats"], source: "user-manual/reference/bootloader.md" },
    { question: "What defines a tactical-grade IMU per the FAQ?", correct: "Gyro IRBS between 0.5 and 5 deg/hour", distractors: ["Any MEMS gyro", "Bias under 50 deg/hour", "RTK fix present"], source: "user-manual/faq.md" },
    { question: "Why was the product name changed from uINS to IMX?", correct: "To reflect broader capabilities beyond INS and cover IMU/AHRS/INS/RTK", distractors: ["Marketing only", "Hardware shrank", "No reason given"], source: "user-manual/faq.md" },
    { question: "How long does standard dead reckoning run without GPS before disabling?", correct: "Disabled after about 7 seconds to limit drift", distractors: ["Never disables", "After 1 hour", "After 1 second"], source: "user-manual/faq.md" },
    { question: "Can IMX operate underwater for positioning?", correct: "Only if GPS antenna stays above water; IMX can dead reckon briefly", distractors: ["Works fully submerged indefinitely", "Needs no GPS", "Never works near water"], source: "user-manual/faq.md" },
    { question: "What vibration level can degrade IMX accuracy per FAQ?", correct: "Vibrations above ~3 g around 100–150 Hz may degrade accuracy", distractors: ["Any vibration stops IMX", "No effect from vibration", "Only DC offsets matter"], source: "user-manual/faq.md" },
    { question: "What can cause data to look wrong per firmware troubleshooting?", correct: "EvalTool/SDK version mismatch with firmware protocol", distractors: ["USB cable color", "GPS antenna brand", "CAN termination"], source: "user-manual/troubleshooting/firmware.md" },
    { question: "What should you check if the bootloader is not responding?", correct: "Clean 3.3V supply, grounded serial, and short serial wires (<1 m)", distractors: ["Disable PPS", "Switch to CAN", "Lower CNO"], source: "user-manual/troubleshooting/firmware.md" },
    { question: "Why might the first bootloader update fail on USB?", correct: "Port number changes when switching to bootloader mode; reselect and rerun", distractors: ["File name too long", "Too many satellites", "Low CPU temperature"], source: "user-manual/troubleshooting/firmware.md" },
    { question: "Why might units stay in AHRS despite GPS messages?", correct: "Rover RTK mode forces AHRS; disable rover mode", distractors: ["Wrong USB cable", "Too high baud", "Missing magnetometer"], source: "user-manual/troubleshooting/firmware.md" },
    { question: "How do you recover a 'bricked' IMX per the guide?", correct: "Assert chip erase pin high at boot to enter ROM bootloader DFU", distractors: ["Press PWR for 30s", "Change antenna", "Send $PERS"], source: "user-manual/troubleshooting/firmware.md" },
    { question: "How does antenna baseline affect heading fix time?", correct: "Short baselines (<1 m) slow/impact fix; increase to ≥0.5 m to improve", distractors: ["Baseline does not matter", "Long baselines reduce accuracy", "Only baud rate matters"], source: "user-manual/troubleshooting/gnss.md" },
    { question: "What CNO level indicates healthy GNSS per troubleshooting?", correct: "Mean CNO ideally above 38–40 dB-Hz", distractors: ["Below 20 is fine", "CNO not used", "Only SNR matters"], source: "user-manual/troubleshooting/gnss.md" },
    { question: "What interference source is commonly cited for GNSS?", correct: "USB 3.0 noise interfering with GNSS signals", distractors: ["HDMI cables only", "Ethernet cables only", "AA batteries"], source: "user-manual/troubleshooting/gnss.md" },
    { question: "How should you route antenna cables to avoid loops?", correct: "Avoid bundling/looping; keep cables as short and direct as practical", distractors: ["Wrap tightly in coils", "Tie to power cables", "Run inside RF shield"], source: "user-manual/troubleshooting/gnss.md" },
    { question: "How should dual antennas be oriented for best heading?", correct: "Coax exits in the same direction on both antennas", distractors: ["Random orientation", "Back-to-back", "Point cables toward each other"], source: "user-manual/troubleshooting/gnss.md" },
    { question: "How does the device appear in Windows during bootloader mode?", correct: "As STM32 BOOTLOADER in Device Manager", distractors: ["As COM0 only", "As GPS Mouse", "As HID Keyboard"], source: "user-manual/troubleshooting/imx_bootloader.md" },
    { question: "Where should the STM32 BOOTLOADER device appear with correct driver?", correct: "Under Universal Serial Bus devices", distractors: ["Ports (COM/LPT) only", "Network adapters", "Audio devices"], source: "user-manual/troubleshooting/imx_bootloader.md" },
    { question: "What tool installs the correct Windows DFU driver?", correct: "Zadig generic USB driver installer", distractors: ["Device Manager only", "Arduino IDE", "EvalTool"], source: "user-manual/troubleshooting/imx_bootloader.md" },
    { question: "What step should you take before installing the new driver?", correct: "Uninstall the old STM32 BOOTLOADER driver from Device Manager", distractors: ["Change baud rate", "Remove GPS antenna", "Disable CAN"], source: "user-manual/troubleshooting/imx_bootloader.md" },
    { question: "What can interrupt bootloader negotiation?", correct: "Data arriving on other ports; disable other streams during update", distractors: ["High CNO", "Low battery", "Using PPS"], source: "user-manual/troubleshooting/imx_bootloader.md" },
    { question: "What does asserting chip erase pin 17 do?", correct: "Erases all flash (firmware, settings, calibration) to enter DFU", distractors: ["Enables CAN", "Resets baud rate only", "Powers antenna"], source: "user-manual/troubleshooting/chip_erase.md" },
    { question: "When should chip erase be used?", correct: "Only as a last resort after other recovery methods fail", distractors: ["As routine reset", "Before every update", "To change baud"], source: "user-manual/troubleshooting/chip_erase.md" },
    { question: "How do you chip erase a Rugged-3?", correct: "Short the ERASE pads and reset to apply 3.3V to the erase pin", distractors: ["Press the power button", "Hold PPS high", "Remove antenna"], source: "user-manual/troubleshooting/chip_erase.md" },
    { question: "What must be restored after chip erase?", correct: "Bootloader/app firmware and sensor calibration via EvalTool Manufacturing tab", distractors: ["Only baud rate", "Nothing; it auto-restores", "Just GPS almanac"], source: "user-manual/troubleshooting/chip_erase.md" },
    { question: "How do you enable EvalTool Internal Mode to load calibration?", correct: "Set DBGINT to 99 in Documents/Inertial Sense/settings.json and restart EvalTool", distractors: ["Press F12", "Hold reset", "Use $PERS"], source: "user-manual/troubleshooting/chip_erase.md" },
    { question: "Where is the Binary Communications example source located?", correct: "ExampleProjects/ISComm/ISCommExample.cpp in the SDK", distractors: ["EvalTool folder", "Firmware hex", "Arduino IDE examples"], source: "user-manual/SDK/CommunicationsBinary.md" },
    { question: "Which function initializes the comm parser?", correct: "is_comm_init(&comm, buffer, sizeof(buffer))", distractors: ["init_uart()", "start_can()", "gps_init()"], source: "user-manual/SDK/CommunicationsBinary.md" },
    { question: "What should you send before enabling new streams?", correct: "is_comm_stop_broadcasts_all_ports to halt prior broadcasts", distractors: ["$STPB only", "CAN reset", "SPI reset"], source: "user-manual/SDK/CommunicationsBinary.md" },
    { question: "How do you request INS/GPS/IMU data in the example?", correct: "Use is_comm_get_data_to_buf with desired DID and period multiple", distractors: ["Send NMEA only", "Use HTTP GET", "Write to flashCfg"], source: "user-manual/SDK/CommunicationsBinary.md" },
    { question: "How are persistent streams saved in the example?", correct: "Send SYS_CMD_SAVE_PERSISTENT_MESSAGES via is_comm_set_data_to_buf", distractors: ["Power cycle twice", "Use $PERS", "Change baud"], source: "user-manual/SDK/CommunicationsBinary.md" },
    { question: "Which command stops broadcasts in the ASCII example?", correct: "STPB", distractors: ["PERS", "INFO", "BOOT"], source: "user-manual/SDK/CommunicationsAscii.md" },
    { question: "What does ASCE configure?", correct: "Enables ASCII/NMEA message broadcasts with IDs and periods", distractors: ["Flash erase", "CAN filters", "SPI mode"], source: "user-manual/SDK/CommunicationsAscii.md" },
    { question: "How is the target serial port selected in ASCE?", correct: "Options field: 0 current, 1=ser0, 2=ser1, 3=both", distractors: ["By baud rate", "By GPIO jumper", "By GPS fix"], source: "user-manual/SDK/CommunicationsAscii.md" },
    { question: "Which helper adds checksum/terminator for ASCII commands?", correct: "serialPortWriteAscii", distractors: ["is_comm_set_data", "printf", "gps_write"], source: "user-manual/SDK/CommunicationsAscii.md" },
    { question: "Which example message enables PINS1 at 10 Hz?", correct: "\"ASCE,0,3,1\"", distractors: ["\"ASCE,0,6,1\"", "\"PERS\"", "\"ASCE,3,6,1\""], source: "user-manual/SDK/CommunicationsAscii.md" },
    { question: "Which Arduino boards are supported for the SDK example?", correct: "32-bit boards with 64-bit double (e.g., Arduino Due)", distractors: ["8-bit Uno only", "Any 8051", "Only STM32"], source: "user-manual/SDK/CommunicationsArduino.md" },
    { question: "How are existing broadcasts stopped in the Arduino example?", correct: "Call is_comm_stop_broadcasts_all_ports and write the buffer to the device", distractors: ["Send $STPB over CAN", "Hold reset low", "Disable PPS"], source: "user-manual/SDK/CommunicationsArduino.md" },
    { question: "Which data set is streamed in the Arduino example?", correct: "DID_INS_1 at 20 Hz", distractors: ["DID_MAGNETOMETER only", "DID_SYS_PARAMS only", "No streaming"], source: "user-manual/SDK/CommunicationsArduino.md" },
    { question: "How large is the comm buffer used in the example?", correct: "About 1 KB (1024 bytes)", distractors: ["64 bytes", "8 KB", "No buffer"], source: "user-manual/SDK/CommunicationsArduino.md" },
    { question: "What coding tip is given for configuration constants?", correct: "Use enums in data_sets.h like SYS_CFG_BITS_RTK_ROVER for clarity", distractors: ["Hardcode hex literals", "Avoid enums", "Use float literals"], source: "user-manual/SDK/CommunicationsArduino.md" },
    { question: "Which class wraps comms and logging in the logger example?", correct: "InertialSense class", distractors: ["std::iostream", "LoggerBase", "SerialPort"], source: "user-manual/SDK/DataLogger.md" },
    { question: "How do you pick the log file type in the logger example?", correct: "Set cISLogger::sSaveOptions.logType (default LOGTYPE_DAT or ParseLogType)", distractors: ["Change baud rate", "Rename .dat to .csv", "Use $PERS"], source: "user-manual/SDK/DataLogger.md" },
    { question: "Where are logs stored by default in the example?", correct: "\"IS_logs\" folder in the current directory", distractors: ["~/Documents", "SD card only", "Temp folder"], source: "user-manual/SDK/DataLogger.md" },
    { question: "How are standard messages enabled for logging?", correct: "Call BroadcastBinaryDataRmcPreset()", distractors: ["Enable CAN", "Use only INS_1", "Edit firmware"], source: "user-manual/SDK/DataLogger.md" },
    { question: "What is the first step shown in the logger example?", correct: "Instantiate InertialSense with a data callback and open the port", distractors: ["Erase flash", "Run bootloader", "Change antenna"], source: "user-manual/SDK/DataLogger.md" },
    { question: "Which parameters are set before bootloadFileEx runs?", correct: "bootload_params_t with port, baudRate, fileName, optional bootName", distractors: ["GPS baseline", "INS offsets", "Mag calibration"], source: "user-manual/SDK/FirmwareUpdate.md" },
    { question: "How do you select the serial port for bootloading?", correct: "Use serialPortSetPort(&serialPort, argv[1])", distractors: ["Edit flashCfg", "Press EvalTool button", "Send $STPB"], source: "user-manual/SDK/FirmwareUpdate.md" },
    { question: "How do you optionally force bootloader update in the example?", correct: "Set forceBootloaderUpdate and provide bootName if needed", distractors: ["Disable PPS", "Short reset pin", "Change baud"], source: "user-manual/SDK/FirmwareUpdate.md" },
    { question: "What indicates bootload success in the sample code?", correct: "bootloadFileEx returns 0 and prints success message", distractors: ["LED turns purple", "GPS fix", "CAN idle"], source: "user-manual/SDK/FirmwareUpdate.md" },
    { question: "Which headers are included for bootloader support?", correct: "ISBootloaderThread.h and ISBootloaderBase.h", distractors: ["IMU.h", "EvalTool.h", "NMEA.h"], source: "user-manual/SDK/FirmwareUpdate.md" },
    { question: "What does the SDK README say about the SDK scope?", correct: "Open-source SDK for IMX/uAHRS/uIMU with logger, math, and serial interfaces", distractors: ["Windows-only GUI", "GNSS firmware only", "CAN analyzer"], source: "user-manual/SDK/README.md" },
    { question: "What does EvalTool provide per the README?", correct: "Windows GUI with plots, 3D model, data logger, and firmware updater", distractors: ["Only CLI logging", "ROS node only", "Bootloader only"], source: "user-manual/SDK/README.md" },
    { question: "How is CLTool described?", correct: "Cross-platform command-line utility and example for comms/logging/firmware", distractors: ["Only a bootloader GUI", "Android app", "Hardware debugger"], source: "user-manual/SDK/README.md" },
    { question: "Under what license is the SDK released?", correct: "MIT License (2014-2026 Inertial Sense)", distractors: ["GPLv3", "Proprietary only", "Apache 1.0"], source: "user-manual/SDK/README.md" },
    { question: "What does the InertialSense C++ class provide?", correct: "Serial comms, logging, and firmware update features for IS devices", distractors: ["Only GUI rendering", "CAN analyzer", "GPS constellation simulation"], source: "user-manual/SDK/InertialSenseClassCLTool.md" },
    { question: "What is the CLTool project used to illustrate?", correct: "Implementing the InertialSense C++ class for comms/logging/updates", distractors: ["Arduino PWM control", "GNSS-only drivers", "PCB routing"], source: "user-manual/SDK/InertialSenseClassCLTool.md" },
    { question: "How do you open the serial port with the class?", correct: "Call inertialSenseInterface.Open(comPort, baudRate, disableBroadcastsOnClose)", distractors: ["Write directly to UART registers", "Use only EvalTool GUI", "Change ioConfig"], source: "user-manual/SDK/InertialSenseClassCLTool.md" },
    { question: "How do you keep communications active in the CLTool example?", correct: "Call Update() regularly in the main loop and process callbacks", distractors: ["Poll PPS edges", "Send $STPB repeatedly", "Power cycle often"], source: "user-manual/SDK/InertialSenseClassCLTool.md" },
    { question: "Where are incoming datasets handled in the example?", correct: "In the data callback, copying p_data_t into uDatasets and switching on hdr.id", distractors: ["In a web server", "Only via CAN ISR", "Inside EvalTool only"], source: "user-manual/SDK/InertialSenseClassCLTool.md" },
