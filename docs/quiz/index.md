...
(() => {
  const contentQuestions = [
    ...
    { question: "Where do you set the GNSS antenna lever arm offsets?", correct: "DID_FLASH_CONFIG.gnss1AntOffset / gpsAnt2Offset", distractors: ["insRotation", "platformConfig", "sensorConfig"], source: "user-manual/application-config/imu_ins_configuration.md" },
